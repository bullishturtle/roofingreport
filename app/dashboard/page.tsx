    ...
    <DashboardShell>
      ...
      <div className="grid gap-4 md:gap-8">
        ...
        <div className="mt-4 relative">
          <Card className="border-blue-500/30 bg-white/5 backdrop-blur-sm overflow-hidden">
            <CardHeader>
              <CardTitle className="text-white flex items-center gap-2">
                <span className="text-blue-400">Pro</span> Feature: Storm Damage Leads
              </CardTitle>
              <CardDescription className="text-white/70">
                Automatically identify properties with recent storm damage in your target areas.
              </CardDescription>
            </CardHeader>
            <CardContent className="blur-sm">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 border rounded-md border-blue-500/30 bg-blue-500/5">
                  <div className="text-sm text-white/70 mb-1">New Hail Damage Leads</div>
                  <div className="text-2xl font-bold text-white">24</div>
                  <div className="text-xs text-white/50 mt-1">Last 7 days</div>
                </div>
                <div className="p-4 border rounded-md border-blue-500/30 bg-blue-500/5">
                  <div className="text-sm text-white/70 mb-1">Wind Damage Properties</div>
                ...
                <div className="p-4 border rounded-md border-blue-500/30 bg-blue-500/5">
                  ...
                  <div className="text-xs text-white/50 mt-1">+2.3% from last month</div>
                </div>
              </div>
            </CardContent>
            <div className="absolute inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm">
              <div className="text-center p-6">
                ...
                <p className="text-white/70 mb-4">
                  Upgrade to RoofFax Pro to access storm damage lead generation and more.
                </p>
                <Button
        ...
        <Tabs defaultValue="map" className="w-full">
          ...
          <TabsContent value="analytics" className="border rounded-md p-4 border-white/10 bg-white/5 backdrop-blur-sm">
            <div className="flex items-center justify-between mb-4">
              <div>
