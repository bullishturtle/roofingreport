                ...
                <div className="flex flex-col justify-center space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="max-w-[600px] text-white/70 md:text-xl">
                      Tired of juggling a dozen apps? RoofFax brings roof measurement, storm tracking, skip tracing,
                      code lookups, proposals, and instant outreach together—guided by Roofus, built for closers.
                    </p>
                  </div>
                  <HeroSearch />
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent p-6 flex items-end">
                    <div className="w-full">
                      <div className="mb-2 flex items-center justify-between">
                        <Badge
                          variant="outline"
                          className="bg-black/80 backdrop-blur border-neon-gold/30 text-neon-gold"
                        >
                          Live Demo
                        </Badge>
                        <Button
            ...
            <div className="container px-4 md:px-6 relative z-10">
              ...
              <div className="mx-auto grid max-w-5xl items-start gap-6 py-12 md:grid-cols-3">
                ...
                <div className="flex flex-col items-center space-y-2 text-center p-6 rounded-xl border-2 border-neon-gold/20 bg-black/50 backdrop-blur-sm shadow-neon-glow">
                  ...
                  <p className="text-white/70">
                    Receive a comprehensive roof report with measurements, condition assessment, and actionable
                    insights.
                  </p>
                </div>
              </div>
