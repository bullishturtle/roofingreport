...
export function RoofusAIAssistant() {
  ...
  return (
    <>
      ...
      {/* Chat panel */}
      {isOpen && (
        <div className="fixed bottom-6 right-6 z-50 w-80 md:w-96 h-96 bg-black/90 border border-neon-gold/30 rounded-lg shadow-neon-glow overflow-hidden">
          <div className="flex items-center justify-between p-3 border-b border-neon-gold/30 bg-gradient-to-r from-neon-gold/20 to-neon-orange/20">
            <div className="flex items-center gap-2">
              <div className="h-8 w-8 rounded-full bg-gradient-to-br from-neon-gold to-neon-orange flex items-center justify-center">
                <span className="text-sm font-bold text-black">R</span>
              </div>
              <span className="font-medium text-white">Roofus AI Assistant</span>
            </div>
            <Button
              variant="ghost"
              size="icon"
          ...
          <div className="flex flex-col h-[calc(100%-56px)]">
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              <div className="bg-neon-gold/10 rounded-lg p-3 max-w-[80%]">
            ...
            <div className="p-3 border-t border-neon-gold/30">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Type your message..."
                  className="w-full bg-white/5 border border-neon-gold/30 rounded-md py-2 px-3 text-white placeholder:text-white/50 focus:outline-none focus:ring-1 focus:ring-neon-gold"
                />
                <Button
                  size="sm"
                  className="absolute right-1 top-1 bg-gradient-to-r from-neon-gold to-neon-orange hover:from-neon-orange hover:to-neon-gold text-black h-7"
                >
                  Send
                </Button>
              </div>
      ...
      {/* Chat dialog - Commented out for now */}
      {/* 
      <AnimatePresence>
        {isOpen && (
          <motion.div
